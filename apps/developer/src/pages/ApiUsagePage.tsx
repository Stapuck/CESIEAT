        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          {quota.used > quota.limit * 0.8 ? (
            <div className="bg-red-50 border-l-4 border-red-500 p-4 mb-4">
              <div className="flex">
                <div className="flex-shrink-0">
                  <svg className="h-5 w-5 text-red-500" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="bg-green-50 border-l-4 border-green-500 p-4 mb-4">
              <div className="flex">
                <div className="flex-shrink-0">
                  <svg className="h-5 w-5 text-green-500" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">

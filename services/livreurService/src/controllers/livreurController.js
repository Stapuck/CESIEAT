...
export const getLivreurs = async (c) => {
    try {
...
export const getLivreur = async (c) => {
    try {
...
export const createLivreur = async (c) => {
    try {
...
export const editLivreur = async (c) => {
    try {
        const id = c.req.param('id');
        const body = await c.req.json();
...
export const deleteLivreur = async (c) => {
    try {
        const id = c.req.param('id');
...
export const getAvailableLivreurs = async (c) => {
    try {

      ...
      <div className="flex flex-col text-black">
        ...
        <div className="flex justify-around items-center mt-4">
          ...
          <div className="flex flex-col">
            <Link to="/technical/faq"> Question fréquente</Link>
            <Link to="/technical/aboutus"> A propos de nous</Link>
            <Link to="/technical/contact"> Nous contacter</Link>
          </div>

          <div className="flex flex-col">
            <Link to="/technical/promotion">Promotion</Link>
            <Link to="/technical/tarif">Tarif</Link>
          </div>
          <div className="flex flex-col">
            <Link to="/technical/confidentialité">
              Politique de confidentialité
            </Link>
            <Link to="/technical/terms"> Condition d'utilisation </Link>
          </div>
        </div>

...
function Protected() {
    ...
    useEffect(() => {
        if (!auth.isLoading && !auth.isAuthenticated && !redirectToastShown.current) {
        ...
        return (
            <div className="flex justify-center items-center h-screen bg-gray-50">
                <div className="text-center p-8 bg-white rounded-lg shadow-md">
                    ...
                    <p className="text-gray-500 mt-2">Vérification de votre authentification</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="flex justify-center items-center h-screen bg-red-50">
                <div className="text-center p-8 bg-white rounded-lg shadow-md max-w-lg">
                    ...
                    <h2 className="text-xl font-semibold text-gray-700">Erreur d'authentification</h2>
    ...
    if (auth.isAuthenticated) {
        console.log("Utilisateur authentifié, passage du contexte login=true à Outlet");

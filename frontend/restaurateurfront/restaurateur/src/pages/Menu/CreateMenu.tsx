                ...
                <div className="space-y-2">
                    ...
                    <div>
                        ...
                        {selectedArticles.map((selectedArticle, index) => (
                            <select key={index} value={selectedArticle} onChange={(e) => handleArticleChange(index, e.target.value)} className="w-full block border p-3 rounded mt-2">
                    ...
                    <div>
                        {!isLoading && (
                            <button className="block w-full mt-6 bg-blue-700 text-white rounded px-4 py-2 font-bold hover:bg-blue-600">Enregistrer</button>
                        )}
                    </div>
                </div>
            </form>

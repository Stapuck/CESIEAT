        ...
        <div>
            <div  className="bg-white rounded shadow-lg overflow-hidden m-3 p-4">
                ...
                <div className="mt-2 flex gap-4">
                    <Link to={`/restaurateur/edit-menu/${menu._id}`} className="inline-block w-full text-center shadow-md text-sm bg-gray-700 text-white rounded-sm px-4 py-1 font-bold hover:bg-gray-600 hover:cursor-pointer">
                        Modifier
                    </Link>

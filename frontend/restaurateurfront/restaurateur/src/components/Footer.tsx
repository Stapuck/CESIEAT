            ...
            <div className="flex flex-col text-black">
                ...
                <div className="flex justify-around items-center mt-4">
                    <div className="flex p-2 justify-around">
                        <img src="https://img.icons8.com/ios/50/000000/facebook-new.png" alt="Facebook" className="p-2" />
                        <img src="https://img.icons8.com/ios/50/000000/twitter.png" alt="Twitter" className=" p-2" />
                        <img src="https://img.icons8.com/ios/50/000000/instagram-new.png" alt="Instagram" className=" p-2" />

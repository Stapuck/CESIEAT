      ...
      <div className="flex flex-col text-black">
        ...
        <div className="flex justify-around items-center mt-4">
          ...
          <div className="flex flex-col">
            <Link to="/restaurateur/faq"> Question fréquente</Link>
            <Link to="/restaurateur/aboutus"> A propos de nous</Link>
            <Link to="/restaurateur/contact"> Nous contacter</Link>
          </div>

          <div className="flex flex-col">
            <Link to="/restaurateur/promotion">Promotion</Link>
            <Link to="/restaurateur/tarif">Tarif</Link>
          </div>
          <div className="flex flex-col">
            <Link to="/restaurateur/confidentialité">
              Politique de confidentialité
            </Link>
            <Link to="/restaurateur/terms"> Condition d'utilisation </Link>
          </div>
        </div>

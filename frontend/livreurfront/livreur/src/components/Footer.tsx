      ...
      <div className="flex flex-col text-black">
        ...
        <div className="flex justify-around items-center mt-2">
          ...
          <div className="flex flex-col">
            <Link to="/livreur/faq"> Question fréquente</Link>
            <Link to="/livreur/aboutus"> A propos de nous</Link>
            <Link to="/livreur/contact"> Nous contacter</Link>
          </div>

          <div className="flex flex-col">
            <Link to="/livreur/promotion">Promotion</Link>
            <Link to="/livreur/tarif">Tarif</Link>
          </div>
          <div className="flex flex-col">
            <Link to="/livreur/confidentialité">
              Politique de confidentialité
            </Link>
            <Link to="/livreur/terms"> Condition d'utilisation </Link>
          </div>
        </div>
